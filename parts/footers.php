<?php
/**
 * A common footer template.
 *
 * Style guide in style-guide/common-footer.html
 */
?>
<footer class="row single gutter pad-top bg-none site-footer">
	<div class="column one">
		<div class="deck">
			<?php
			if ( has_nav_menu( 'footer-one' ) || has_nav_menu( 'footer-two' ) ) {
				?>
				<nav class="card card--nav">
				<?php

				if ( has_nav_menu( 'footer-one' ) ) {
					?>
					<div class="nav-group">
						<header><?php echo esc_html( wp_get_nav_menu_name( 'footer-one' ) ); ?></header>
				...
				if ( has_nav_menu( 'footer-two' ) ) {
					?>
					<div class="nav-group">
						<header><?php echo esc_html( wp_get_nav_menu_name( 'footer-two' ) ); ?></header>
